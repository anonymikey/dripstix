...
const HowItWorks = () => (
  <section className="py-16 sm:py-24 bg-card">
    <div className="container max-w-5xl">
      <p className="text-center text-xs sm:text-sm font-semibold tracking-[0.2em] uppercase text-primary mb-3">
        How It Works
      </p>
      <h2 className="text-center text-3xl sm:text-4xl md:text-5xl font-display font-bold text-foreground mb-12 sm:mb-16">
        Order your stickers —<br className="hidden sm:block" /> step by step
      </h2>

      {/* Desktop: horizontal line with circles */}
      <div className="hidden md:block relative">
        ...
        <div className="grid grid-cols-4 gap-6">
          {steps.map((step, i) => (
            ...
            >
              <div className="relative z-10 w-12 h-12 rounded-full border-2 border-primary bg-background flex items-center justify-center text-primary font-bold text-lg mb-6">
                {step.number}
              </div>
      ...
      <div className="md:hidden space-y-8 relative pl-8">
        ...
        {steps.map((step, i) => (
          ...
          >
            <div className="relative z-10 shrink-0 w-10 h-10 rounded-full border-2 border-primary bg-background flex items-center justify-center text-primary font-bold text-sm -ml-8">
              {step.number}
            </div>
            <div>
